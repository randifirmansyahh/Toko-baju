...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-yellow text-green navbar navbar-expand-md navbar-dark d-print-none">
        <div className="container-xl">
          ...
          <h1 className="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <Link to="/">
              <img
                src="https://1.bp.blogspot.com/-uhl9mtK74s0/YFTYEJ62kMI/AAAAAAAAB_s/FunJpTwdoUskbNPKELkc_12nBy8ULm-swCNcBGAsYHQ/s2048/Evos%2BEsports.png"
                width="110"
                height="32"
                alt="Tabler"
